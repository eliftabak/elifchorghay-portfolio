...
export default function Home() {
	return (
		<main>
			<section className="contain mb-32 md:mb-24 md:mt-20">
				...
				<p className="text-mdgray my-8 md:text-lg max-w-2xl">
					...
					Solutions &mdash; Creating Intuitive, High-Performance Web
					Applications.
				</p>
        <div className="text-mdgray my-6 flex items-baseline">
					...
					>
						<Image src={"images/socials/github-mark.svg"} width={30} height={30} alt="github-logo" />
					</Link>
					<Link
						...
						rel="noopener noreferrer"
					>
            <Image src={"images/socials/linkedin.svg"} width={33} height={33} alt="linkedin-logo" />
					</Link>
				</div>
				<div>
