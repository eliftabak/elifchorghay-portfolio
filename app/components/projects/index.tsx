          ...
          <div className="md:w-7/12 lg:w-12/12 p-10 md:p-24">
            ...
            <ul className="flex mb-4 text-mdgray text-sm">
              {project.technologies.map((tech, i) => (
                <li key={i} className="mr-4">{tech}</li>
              ))}
            </ul>
            <div className="flex">
              {project.links.video && (
              ...
              {project.links.github && (
                <a href={project.links.github} target="_blank" rel="noopener noreferrer" className="mr-4">
                  <svg width="20" height="20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              {project.links.figma && (
                <a href={project.links.figma} target="_blank" rel="noopener noreferrer" className="mr-4">
                  <Image width="17" height="20" style={{ filter: 'grayscale(100%)' }} alt="Figma-logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/Figma-logo.svg/256px-Figma-logo.svg.png" />
                </a>
              )}
              {project.links.live && (
